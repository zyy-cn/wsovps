...
if __name__ == '__main__':
    ...
    parser.add_argument('--test_dataset', type=str, default='../coco2014_b14/val.pth', help="Directory of the test file") 
    parser.add_argument('--train_dataset', type=str, default='../coco2014_b14/train.pth', help="Directory of the train file") 
    parser.add_argument('--val_dataset', type=str, default='../coco2014_b14/val.pth', help="Directory of the validation file") 
