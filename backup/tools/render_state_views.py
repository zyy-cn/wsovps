...
def main() -> int:
    ...
    active_experiments = [
        ...
        if e.get("status") in {"approved", "prepared", "running", "summarized", "reviewed", "interrupted", "failed"}
    ]
    ...
    loop_state = {
        ...
        "active_gate_id": gate_reg.get("active_scientific_gate", "not-yet-declared"),
